    ...
    <div class="d-flex gap-3">
        <div class="form-check">
            <input class="form-check-input" type="radio" name="submission_type" id="typeMember"
                   value="member" @checked(old('submission_type', $hki->submission_type) === 'member') data-switch>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="submission_type" id="typeNonMember"
                   value="non_member" @checked(old('submission_type', $hki->submission_type) !== 'member') data-switch>
            <label class="form-check-label" for="typeNonMember">Non-Member (isi manual)</label>
        </div>
    </div>
</div>

<div id="memberField" class="mb-3" data-switch-panel="member" @if (old('submission_type', $hki->submission_type) !== 'member') hidden @endif>
...
<div id="nonMemberField" class="mb-3" data-switch-panel="non_member" @if (old('submission_type', $hki->submission_type) === 'member') hidden @endif>
...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="pencipta" data-dosen-picker
