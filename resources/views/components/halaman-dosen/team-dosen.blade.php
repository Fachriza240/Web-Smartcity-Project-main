    ...
    <div class="container">
        ...
        <div class="search-filters mb-4">
            <div class="filter-tabs">
                <button class="filter-tab active" data-target="staff-section-dosen">STAFF</button>
                <button class="filter-tab" data-target="interns-section-dosen">INTERNS</button>
            </div>
        </div>

        <!-- Staff Section -->
        <div id="staff-section-dosen" class="table-section">
                        ...
                        <div class="col-md-3">
                            ...
                            @if($member->linkedin || $member->instagram || $member->github)
                                <div class="d-flex gap-2 mt-1">
                                    @if($member->linkedin) <a href="{{ $member->linkedin }}" target="_blank" class="text-primary small"><i class="bi bi-linkedin"></i></a> @endif
                                    @if($member->instagram) <a href="https://instagram.com/{{ ltrim($member->instagram,'@') }}" target="_blank" class="text-danger small"><i class="bi bi-instagram"></i></a> @endif
                                    @if($member->github) <a href="https://github.com/{{ $member->github }}" target="_blank" class="text-dark small"><i class="bi bi-github"></i></a> @endif
                                </div>
                            @endif
                        </div>
                    </div>
        ...
        <!-- Interns Section -->
        <div id="interns-section-dosen" class="table-section" style="display:none;">
            <div class="lecturer-table-header">
                <div class="row align-items-center py-3 border-bottom">
                    <div class="col-md-1"></div>
                    <div class="col-md-2">Nama Belakang</div>
            ...
            <div class="lecturer-listing">
                @forelse($interns as $member)
                    ...
                    <div class="row lecturer-row align-items-center py-4 border-bottom" data-aos="fade-up">
                        ...
                        <div class="col-md-2"><div class="lecturer-phone">{{ $member->telepon ?? '-' }}</div></div>
                        <div class="col-md-2">
                            @if($member->email) <a href="mailto:{{ $member->email }}" class="lecturer-email">{{ $member->email }}</a>
                            @else <span class="text-muted">-</span> @endif
                        </div>
                        <div class="col-md-3">
                            <div class="lecturer-position">{{ $member->jabatan }}</div>
